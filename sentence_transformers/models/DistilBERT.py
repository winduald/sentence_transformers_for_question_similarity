...
class DistilBERT(nn.Module):
    ...
    """
    def __init__(self, model_name_or_path: str, max_seq_length: int = 510, do_lower_case: Optional[bool] = None, model_args: Dict = {}, tokenizer_args: Dict = {}):
